...
public class CartController {
    ...
    public ResponseEntity<?> checkout(@RequestParam(name = "userId") String userId,@ModelAttribute(name = "address") String address) {
        try {
            System.out.println("User ID: " + userId); // In ra userId để kiểm tra
            gioHangChiTietService.checkout(userId,address); // Kiểm tra xem có lỗi khi gọi phương thức này không
