...
public class HoaDon {
    ...
    public HoaDon(Date ngaytao, String trangthai, String diachi, String giaohang) {
    ...
    public HoaDon(Users users, Date ngaytao, String trangthai, String diachi, String giaohang, List<HoaDonChiTiet> hoaDonChiTiets) {
        this.users = users;
        this.ngaytao = ngaytao;
        this.trangthai = trangthai;
        this.diachi = diachi;
    ...
    @Column(name = "giaohang") // Ánh xạ với cột giaohang trong CSDL
